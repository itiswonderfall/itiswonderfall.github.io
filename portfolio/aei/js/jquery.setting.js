// JavaScript Document
$(function() {
	$('.homeSec1 .single-slider img').wrap('<div class="item"></div>');
	$('.teamListSec .parallax-item:even').addClass('left-direction').parent().after('<div class="col-md-5"></div>');
	$('.teamListSec .parallax-item:odd').addClass('right-direction').parent().before('<div class="col-md-5"></div>');
});
