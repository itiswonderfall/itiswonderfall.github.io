// JavaScript Document
$(function() {
	$('.widget-tags a').on('click',function() {
		$(this).toggleClass('qsNav');
	});
	$('.gdpr__Btn').on('click',function() {
		$(".gdprBlock").css('display','none');
	});
	$('.len-show').on('click',function() {
		$(".widget-len-show").toggleClass('blockD');
	});
	$('.toggle_detail').each(function() {
	  $(this).on('click', function() {
	  	$(this).parents('tr').toggleClass('footable-detail-show');
	  	$(this).parents('tr').next('.footable-row-detail').toggleClass('hidden');
	  });
	});
	$("#show_xxwh").hide();
    $("#xxwh").hover(function () {
    ...
    $("td.dc-ipRange2").next("td.dc-ipRange4").css('vertical-align','top');
    $("td.dc-ipRange4").prev("td.dc-ipRange2").css('vertical-align','top');
});
